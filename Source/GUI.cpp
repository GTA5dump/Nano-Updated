...
RGBA Menu::Settings::SubtitleRect{ 0, 0, 0, 255 };
...
RGBAF Menu::Settings::breakText{ 255, 255, 255, 255, 1 };                          // Mod Menu Colors 
RGBA Menu::Settings::optionRect{ 0, 0, 0, 255 };
RGBA Menu::Settings::scroller{ 255, 51, 255, 255 };
...
void Menu::Drawing::YTD() {
	std::string path = "Kursed/Textures/";
	std::string name = "Kursed.ytd";
...
{
	std::string path = "C://KursedCheats/";
	std::string name = "KursedCheats.ytd";
	const std::string fullPath = path + name;
...
void Menu::End()
{
	...
	if (opcount >= 16) { 
		Drawing::Text(" Kursed Version V1", Settings::count, { Settings::menuX - 0.105f, 17 * 0.035f + 0.130f }, { 0.35f, 0.35f }, false); // Add a text message at the end of the break 
		...
		Drawing::Text(" Kursed Version 2.0", Settings::count, { Settings::menuX - 0.105f,(Settings::optionCount+ 1) * 0.035f + 0.130f }, { 0.35f, 0.35f }, false);// Add a text message at the end of the break 
